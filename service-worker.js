const CACHE='lfmp-professional-final-v1-reset-meter';
const ASSETS=['./','./index.html','./manifest.json','./css/app.css','./js/app.js','./database/films.json','./database/lenses.json','./database/cameras.json','./database/jobo.json','./database/development.json'];
